...
public class MezclaDirecta {
   public String directorio;
    ...
    MezclaDirecta(File archivo, File file1, File file2, int rango, int cmp) throws IOException, FileNotFoundException, ParseException {
    ...
    public void Fusiona(int part) throws FileNotFoundException, IOException, ParseException {
